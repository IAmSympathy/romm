...
# Developer credentials, injected at build time (with default fallbacks).
SCREENSCRAPER_DEV_ID: Final[str | None] = _get_env("SCREENSCRAPER_DEV_ID") or "zurdi15"
SCREENSCRAPER_DEV_PASSWORD: Final[str | None] = _get_env("SCREENSCRAPER_DEV_PASSWORD") or "xTJwoOFjOQG"
